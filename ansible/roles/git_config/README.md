...
Paths, ownership, and known-hosts permissions are inventory-driven so the same
role supports Linux servers and macOS workstations without applying Linux-only
roles to macOS.
