...
The new workflow generates Astro content from the canonical plant workspace under working/plants/, publishes only selected photographs, and keeps working notes, source documents, metadata sidecars, and unselected images outside the public website.

Doctor Robert is now published on BradCooke.com from a single canonical source of truth.
...
* Visually reviewed the published page through the development server.
